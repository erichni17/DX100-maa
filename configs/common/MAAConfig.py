...
def _get_maa_opts(options):
    ...
    if hasattr(options, "maa_logical_spd_cache_mode"):
        opts["logical_spd_cache_mode"] = getattr(
    ...
    if hasattr(options, "maa_virtual_complete_line_drain_lines_per_cycle"):
        opts["virtual_complete_line_drain_lines_per_cycle"] = getattr(
            options, "maa_virtual_complete_line_drain_lines_per_cycle"
        )

    if hasattr(options, "maa_virtual_complete_line_payload_words_per_cycle"):
        opts["virtual_complete_line_payload_words_per_cycle"] = getattr(
            options, "maa_virtual_complete_line_payload_words_per_cycle"
        )

    if hasattr(options, "maa_virtual_complete_line_payload_active_lines"):
        opts["virtual_complete_line_payload_active_lines"] = getattr(
    ...
    if hasattr(options, "maa_soa_jit_active_value_owners"):
        opts["soa_jit_active_value_owners"] = getattr(
    ...
    if hasattr(options, "maa_virtual_index_range_passes"):
        opts["virtual_index_range_passes"] = getattr(
    ...
    if hasattr(options, "maa_virtual_descriptor_spool_read_ahead"):
        opts["virtual_descriptor_spool_read_ahead"] = getattr(
            options, "maa_virtual_descriptor_spool_read_ahead"
        )

    if hasattr(options, "maa_virtual_descriptor_spool_read_credits"):
        opts["virtual_descriptor_spool_read_credits"] = getattr(
            options, "maa_virtual_descriptor_spool_read_credits"
        )

    if hasattr(options, "maa_virtual_descriptor_spool_write_credits"):
        opts["virtual_descriptor_spool_write_credits"] = getattr(
            options, "maa_virtual_descriptor_spool_write_credits"
        )
    ...
    if hasattr(options, "maa_virtual_bounded_global_merge"):
        opts["virtual_bounded_global_merge"] = getattr(
