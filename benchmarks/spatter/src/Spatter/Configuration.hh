...
public:
    ...
    aligned_vector<int> pattern_int;
    aligned_vector<int> pattern_gather_int;
    aligned_vector<int> pattern_scatter_int;
...
template <>
class Configuration<Spatter::Serial> : public ConfigurationBase {
public:
...
#ifdef USE_OPENMP
template <>
class Configuration<Spatter::OpenMP> : public ConfigurationBase {
public:
    Configuration(const size_t id, const std::string name,
                  const std::string kernel, const aligned_vector<size_t> &pattern,
                  const aligned_vector<size_t> &pattern_gather,
...
#ifdef USE_CUDA
template <>
class Configuration<Spatter::CUDA> : public ConfigurationBase {
public:
    Configuration(const size_t id, const std::string name,
                  const std::string kernel, const aligned_vector<size_t> &pattern,
                  const aligned_vector<size_t> &pattern_gather,
