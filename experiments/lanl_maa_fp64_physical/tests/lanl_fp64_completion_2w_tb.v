...
module lanl_fp64_completion_2w_tb;
    ...
    initial begin
        ...
        completion0Ready = 1'b1;
        completion1Ready = 1'b1;
        while (completionsRetired < 7 && cycles < 20) begin
            drainCycle();
            cycles = cycles + 1;
        end
        require(completionsRetired == 7,
        ...
        cycles = 0;
        while (completionsCaptured < 15 && cycles < 100) begin
            @(posedge clock);
            #1;
            cycles = cycles + 1;
        end
        require(completionsCaptured == 15,
        ...
        completion1Ready = 1'b1;
        cycles = 0;
        while (completionsRetired < 15 && cycles < 30) begin
            drainCycle();
            cycles = cycles + 1;
        end
        require(completionsRetired == 15,
        ...
        require(seenTags[24:20] == 5'b11111,
