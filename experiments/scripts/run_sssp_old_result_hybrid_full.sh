...

{
    ...
    printf 'external_admission_dense_metadata_bytes=37748736\n'
    printf 'external_admission_tracker_max_bytes=1024\n'
    printf 'external_application_metadata_bytes=37749760\n'
    printf 'admission_metadata_accelerator_sram_bytes=0\n'
    printf 'page_final_map_entries_per_thread=4096\n'
    printf 'page_final_map_threads=4\n'
    printf 'page_final_map_allocator_bytes=implementation_defined_external_application_memory\n'
