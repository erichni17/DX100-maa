...
The checkpoint file ledger is frozen. Candidate-only O3 restore is active with
16K logical reorder, 4K physical SPD, 32 RowTable slices, two memory channels,
