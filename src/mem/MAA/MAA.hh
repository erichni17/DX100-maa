...
public:
    struct MAAStats : public statistics::Group {
        ...
        std::vector<statistics::Scalar *> IND_SoaJitValueReadResponses;
        std::vector<statistics::Scalar *> IND_SoaJitValueFills;
        std::vector<statistics::Scalar *> IND_SoaJitValueCachedResponses;
        std::vector<statistics::Scalar *> IND_SoaJitValueHits;
        std::vector<statistics::Scalar *> IND_SoaJitValueMergedWaiters;
        std::vector<statistics::Scalar *> IND_SoaJitValueEvictions;
        ...
        std::vector<statistics::Scalar *> IND_SoaJitApplyLaneHighWater;
