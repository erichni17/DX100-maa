...
MAA::MAAStats::MAAStats(statistics::Group *parent, int num_indirect_units, MAA *_maa)
    ...
    for (int indirect_id = 0; indirect_id < num_indirect_units; indirect_id++) {
        ...
        IND_VirtFanoutScanEvents.push_back(new statistics::Scalar(this, MAKE_INDIRECT_STAT_NAME("IND_VirtFanoutScanEvents"), statistics::units::Count::get(), "shared-payload source fanout descriptors scanned"));
        IND_VirtFanoutScanWords.push_back(new statistics::Scalar(this, MAKE_INDIRECT_STAT_NAME("IND_VirtFanoutScanWords"), statistics::units::Count::get(), "logical OffsetTable descriptors scanned for shared-payload fanout"));
        ...
        IND_VirtCompleteLinePayloadStarts.push_back(new statistics::Scalar(
            ...
            statistics::units::Count::get(),
            "complete lines entering bounded payload staging"));
        IND_VirtCompleteLinePayloadCompletions.push_back(
            new statistics::Scalar(
                this,
                MAKE_INDIRECT_STAT_NAME(
                    "IND_VirtCompleteLinePayloadCompletions"),
                statistics::units::Count::get(),
                "complete lines finishing bounded payload staging"));
        IND_VirtCompleteLinePayloadReadCycles.push_back(
            new statistics::Scalar(
                ...
                statistics::units::Cycle::get(),
                "MAA cycles consumed by complete-line payload reads"));
        IND_VirtCompleteLinePayloadBlockedCycles.push_back(
            new statistics::Scalar(
                this,
                MAKE_INDIRECT_STAT_NAME(
