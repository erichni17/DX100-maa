...
void IndirectAccessUnit::executeInstruction() {
    ...
    case Status::Decode: {
        ...
        soa_jit_index_line_issues = 0;
        soa_jit_index_line_responses = 0;
    ...
    case Status::Response: {
        ...
        if (isSoaJitRmw()) {
            ...
            (*maa->stats.IND_SoaJitPredicateRejected[my_indirect_id]) +=
                soa_jit_predicate_rejected;
            (*maa->stats.IND_SoaJitIndexLineReads[my_indirect_id]) +=
                soa_jit_index_line_issues;
            (*maa->stats.IND_SoaJitIndexLineResponses[my_indirect_id]) +=
                soa_jit_index_line_responses;
            ...
            DPRINTF(MAAVirtualTrace,
                    ...
                    "index_lines=%lu/%lu predicate_lines=%lu/%lu "
                    "a_reads=%lu/%lu "
