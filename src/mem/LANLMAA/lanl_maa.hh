...
class LANLMAA : public ClockedObject
{
  private:
    ...
    struct LANLMAAStats : public statistics::Group
    {
        ...
        statistics::Scalar descriptorUmtStateInputBankWaitCycles;
        statistics::Scalar descriptorUmtStatePipelineResultBankStallCycles;
        statistics::Scalar descriptorUmtStateResultDrainBankWaitCycles;
        ...
        statistics::Scalar descriptorUmtStateFpIssueSelectionCandidateInputs;
        statistics::Scalar descriptorUmtStateFpIssueOperandRouteBits;
        statistics::Scalar
            descriptorUmtStateIncrementalFpIssueSelectionCandidateInputs;
        statistics::Scalar
            descriptorUmtStateIncrementalFpIssueOperandRouteBits;
        statistics::Scalar descriptorUmtInputLineWaiterHoldLineCycles;
        statistics::Scalar descriptorUmtStateAllocatedStoreBytes;
        statistics::Scalar descriptorUmtStatePhysicalStoreBytes;
        statistics::Scalar descriptorUmtStateResidualStoreBytes;
        statistics::Scalar descriptorUmtStateTokenLogicalBitsFloor;
        statistics::Scalar descriptorUmtStateFunctionalControlLogicalBitsFloor;
        statistics::Scalar descriptorUmtStateBankSchedulerLogicalBitsFloor;
        statistics::Scalar descriptorUmtStateInstrumentationLogicalBitsFloor;
        statistics::Scalar descriptorUmtStateAuxiliaryLogicalBitsFloor;
        statistics::Scalar
